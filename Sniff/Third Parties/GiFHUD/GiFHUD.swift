...
class GiFHUD: UIView {
    ...
    class var instance : GiFHUD {
        struct Static {
            static let inst : GiFHUD = GiFHUD(centerOfView: CGPoint.zero)
        }
        return Static.inst
    }
    ...
    class func showWithOverlay (_ centerOfView: CGPoint?) {
        dismiss ({
            self.instance.Window.addSubview(self.instance.overlay())
            self.show(centerOfView)
        })
    }
    
    class func show (_ centerOfView: CGPoint?) {
        if let centerOfView = centerOfView {
            GiFHUD.instance.center = centerOfView
        }
        dismiss({
    ...
    class func showForSeconds (_ seconds: Double, centerOfView: CGPoint?) {
        show(centerOfView)
